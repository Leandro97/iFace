...
//		
//		List<Amizade> amizades = Fachada.getInstance().getPedidosAmizadePendentes(Fachada.getInstance().getUsuarioById("emissor2"));
//		
...
//		System.out.println("---");
//		
//		amizades = Fachada.getInstance().getPedidosAmizadePendentes(Fachada.getInstance().getUsuarioById("emissor2"));
//		
//		for(Amizade am : amizades) {
//			System.out.println(am.getSolicitado().getNome() + ". " + am.getSolicitante().getNome());
//		}
...
//		
//		Fachada.getInstance().enviarPedidoComunidade(Fachada.getInstance().getComunidadeById("Teste 1"), Fachada.getInstance().getUsuarioById("emissor"));		
//		Fachada.getInstance().enviarPedidoComunidade(Fachada.getInstance().getComunidadeById("Teste 1"), Fachada.getInstance().getUsuarioById("emissor2"));	
//		
//		List<ComunidadeUsuario> pendencias = Fachada.getInstance().getPedidosComunidadePendentes(Fachada.getInstance().getComunidadeById("Teste 1"));
//		
...
//		System.out.println("---");
//		
//		pendencias = Fachada.getInstance().getPedidosComunidadePendentes(Fachada.getInstance().getComunidadeById("Teste 1"));
//		
//		for(ComunidadeUsuario cu : pendencias) {
//			System.out.println(cu.getComunidade().getNome() + ". " + cu.getParticipante().getNome());
//		}
...
//		Fachada.getInstance().enviarPedidoComunidade(Fachada.getInstance().getComunidadeById("Teste 2"), Fachada.getInstance().getUsuarioById("emissor3"));		
//		Fachada.getInstance().enviarPedidoComunidade(Fachada.getInstance().getComunidadeById("Teste 2"), Fachada.getInstance().getUsuarioById("Droogie123"));	
//		
//		//pegando lista de pedidos de usuário pendentes
//		List<ComunidadeUsuario> pendenciasM = Fachada.getInstance().getPedidosComunidadePendentes(Fachada.getInstance().getComunidadeById("Teste 1"));
//		
